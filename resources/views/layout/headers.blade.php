...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <header>
    <div class="px-8 py-2 bg-dark text-white">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
          <i class="bi bi-house-fill"></i> Hi, {{Auth::user()->nama_user ?? ''}}
            </a>
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
              <a href="/dosen" class="nav-link text-white">
            ...
            <li>
            <div class="dropdown px-2 py-2 float-right ">
    ...
    <div class="px-3 py-2 border-bottom mb-3">
        <div class="text-end">
            <a name="" id="" class="btn btn-light text-dark me-2" href="/user/formulirUser" role="button">
            <i class=""></i><b> Register</b></a>
            <a name="" id="" class="btn btn-dark text-light me-2" href="/logout" role="button">
            <i class=""></i><b> Logout</b></a>
        </div>
      </div>
    </div>
  </header>
